...
const ButtonPage = () => {
  return (
    <>
      <p className="category-tag">Action</p>
  ...
  <button disabled class="msc-btn msc-btn-blue-solid msc-btn-sm">
    Small
      ...
      <br />
      <h2 className="font-bold text-2xl mb-2">With Icon</h2>
      <div className="msc-component-container-row">
        <button className="msc-btn msc-btn-blue-solid flex flex-nowrap">
          <FontAwesomeIcon icon={faDownload} className="icon-btn" />
          Primary
        </button>
        <button className="msc-btn msc-btn-blue-outline flex flex-nowrap">
          <FontAwesomeIcon icon={faDownload} className="icon-btn" />
          Secondary
        </button>
        <button className="msc-btn msc-btn-transparent flex flex-nowrap">
          <FontAwesomeIcon icon={faDownload} className="icon-btn" />
          Tertiary
        </button>
        <button className="msc-btn msc-btn-blue-solid msc-btn-sm flex flex-nowrap justify-center">
          <FontAwesomeIcon icon={faDownload} className="icon-btn" />
          Small
        </button>
      </div>
